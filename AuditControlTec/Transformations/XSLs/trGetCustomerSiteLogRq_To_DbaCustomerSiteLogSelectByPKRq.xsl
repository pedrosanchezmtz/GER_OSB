   ...
   <oracle-xsl-mapper:schema>
      ...
      <oracle-xsl-mapper:mapSources>
         <oracle-xsl-mapper:source type="XSD">
            ...
            <oracle-xsl-mapper:rootElement name="GetCustomerSiteLogRq" namespace="http://soa.estrellaroja.com.mx/AuditControlTec"/>
         </oracle-xsl-mapper:source>
      </oracle-xsl-mapper:mapSources>
      <oracle-xsl-mapper:mapTargets>
         <oracle-xsl-mapper:target type="XSD">
            <oracle-xsl-mapper:schema location="../../Schemas/External/dbaCustomerSiteLogBs_table.xsd"/>
            <oracle-xsl-mapper:rootElement name="XxerArCustSiteLogPrimaryKey" namespace="http://xmlns.oracle.com/pcbpel/adapter/db/top/dbaCustomerSiteLogBs"/>
         </oracle-xsl-mapper:target>
      </oracle-xsl-mapper:mapTargets>
      <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.2.0(XSLT Build 161003.0739.0018) AT [FRI DEC 15 22:16:40 CST 2017].-->
   </oracle-xsl-mapper:schema>
   <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
   <xsl:template match="/">
      <tns:XxerArCustSiteLogPrimaryKey>
         <tns:customerSiteId>
            <xsl:value-of select="/ns0:GetCustomerSiteLogRq/ns0:CustomerSite/ns0:CustomerSiteId"/>
         </tns:customerSiteId>
         <tns:useCode>
            <xsl:value-of select="/ns0:GetCustomerSiteLogRq/ns0:CustomerSite/ns0:UseCode"/>
         </tns:useCode>
      </tns:XxerArCustSiteLogPrimaryKey>
   </xsl:template>
</xsl:stylesheet>