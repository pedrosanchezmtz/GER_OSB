   ...
   <oracle-xsl-mapper:schema>
      ...
      <oracle-xsl-mapper:mapTargets>
         <oracle-xsl-mapper:target type="XSD">
            ...
            <oracle-xsl-mapper:rootElement name="MergeIncPaymentComplementRs" namespace="http://soa.estrellaroja.com.mx/AuditControlTec"/>
         </oracle-xsl-mapper:target>
      </oracle-xsl-mapper:mapTargets>
      <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.2.0(XSLT Build 161003.0739.0018) AT [TUE DEC 12 10:57:40 CST 2017].-->
   </oracle-xsl-mapper:schema>
   <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
   <xsl:template match="/">
      <tns:MergeIncPaymentComplementRs>
         <cmn:Success/>
         <tns:Return>
            <tns:IncPaymentComplementId>
               <xsl:value-of select="/ns0:XxerIncPaymentComplementsCollection/ns0:XxerIncPaymentComplements/ns0:incPaymentComplementId"/>
            </tns:IncPaymentComplementId>
         </tns:Return>
      </tns:MergeIncPaymentComplementRs>
   </xsl:template>
