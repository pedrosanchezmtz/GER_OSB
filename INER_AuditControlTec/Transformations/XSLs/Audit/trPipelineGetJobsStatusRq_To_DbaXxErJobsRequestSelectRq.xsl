   ...
   <oracle-xsl-mapper:schema>
      ...
      <oracle-xsl-mapper:mapTargets>
         <oracle-xsl-mapper:target type="XSD">
            ...
            <oracle-xsl-mapper:rootElement name="dbXXER_JOBS_REQUESTSelect_pInstanceNumberInputParameters" namespace="http://xmlns.oracle.com/pcbpel/adapter/db/top/dbXXER_JOBS_REQUEST"/>
         </oracle-xsl-mapper:target>
      </oracle-xsl-mapper:mapTargets>
      <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.2.0(XSLT Build 161003.0739.0018) AT [WED DEC 13 10:06:27 CST 2017].-->
   </oracle-xsl-mapper:schema>
   <!--User Editing allowed BELOW this line - DO NOT DELETE THIS LINE-->
   <xsl:template match="/">
      <tns:dbXXER_JOBS_REQUESTSelect_pInstanceNumberInputParameters>
         <tns:pInstanceNumber>
            <xsl:value-of select="/ns0:GetJobsStatusRq/ns0:Process/ns0:InstanceId"/>
         </tns:pInstanceNumber>
      </tns:dbXXER_JOBS_REQUESTSelect_pInstanceNumberInputParameters>
   </xsl:template>
</xsl:stylesheet>